...
SIMULINK_EXPORT_EXTERN_C void slmsg_ssSetInputPortFunctionUsed(SimStruct *S, size_t portIdx, bool useReceive, bool useLength, bool useForward, bool useOverflow);
SIMULINK_EXPORT_EXTERN_C void slmsg_ssSetOutputPortFunctionUsed(SimStruct *S, size_t portIdx, bool useSend, bool useForward, bool useOverflow);
...
SIMULINK_EXPORT_EXTERN_C uint_T slmsg_ssRecvDataInSIL(SimStruct* S, int portIdx, void* received_data);
SIMULINK_EXPORT_EXTERN_C uint_T slmsg_ssSendDataInSIL(SimStruct *S, int portIdx, const void* data_to_send);
