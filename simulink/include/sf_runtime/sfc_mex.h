...
LIBMWSF_RUNTIME_API const mxArray* sf_mex_call(emlrtConstCTX aTLS, const char* functionName, unsigned int numReturn, unsigned int numArguments, ...);
LIBMWSF_RUNTIME_API const mxArray* sf_mex_call_debug(emlrtConstCTX aTLS, struct SfDebugInstanceStruct* debugInstance, const char* functionName, unsigned int numReturn, unsigned int numArguments, ...);
